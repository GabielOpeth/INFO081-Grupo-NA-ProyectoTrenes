...
# Importamos la clase central y los modelos
...
# --- ¡IMPORTANTE! NO IMPORTAR SistemaDeGuardado AQUÍ ARRIBA ---
# Si pones "from .sistema_guardado..." aquí, el programa fallará.
...
class EstadoSimulacion:
    ...
    def from_serializable(data):
        ...
        # Limpiar gestores para evitar duplicados
...
def prueba():
    # --- AQUÍ SÍ PODEMOS IMPORTAR ---
    # Al hacerlo dentro de la función, evitamos el bloqueo circular
